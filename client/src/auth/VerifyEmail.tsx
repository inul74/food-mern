          ...
          <div className="flex justify-between">
            {otp.map((letter: string, idx: number) => (
              <Input
                ...
                className="md:w-12 md:h-12 w-9 h-9 text-center text-sm md:text-2xl font-normal md:font-bold rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            ))}
          </div>
          {loading ? (
